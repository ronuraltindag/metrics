...
\KeywordTok{data}\NormalTok{(CASchools)}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{03302020}\NormalTok{)}

\NormalTok{CASchools}\OperatorTok{$}\NormalTok{noise1 <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\DecValTok{1000}\NormalTok{, }\DataTypeTok{size =} \KeywordTok{nrow}\NormalTok{(CASchools), }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{CASchools}\OperatorTok{$}\NormalTok{noise2 <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\DecValTok{1000}\NormalTok{, }\DataTypeTok{size =} \KeywordTok{nrow}\NormalTok{(CASchools), }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{CASchools}\OperatorTok{$}\NormalTok{noise3 <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\DecValTok{1000}\NormalTok{, }\DataTypeTok{size =} \KeywordTok{nrow}\NormalTok{(CASchools), }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{CASchools}\OperatorTok{$}\NormalTok{str <-}\StringTok{ }\NormalTok{CASchools}\OperatorTok{$}\NormalTok{students}\OperatorTok{/}\NormalTok{CASchools}\OperatorTok{$}\NormalTok{teachers}

\NormalTok{CASchools1 <-}\StringTok{ }\NormalTok{CASchools }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(read,str, english, lunch, expenditure)}



\NormalTok{mo1 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data=}\NormalTok{CASchools, }\DataTypeTok{formula=}\NormalTok{read}\OperatorTok{~}\NormalTok{str}\OperatorTok{+}\NormalTok{english)}
\KeywordTok{summary}\NormalTok{(mo1)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{CPS1988}\OperatorTok{$}\NormalTok{educ2 <-}\StringTok{ }\DecValTok{2}\OperatorTok{*}\NormalTok{CPS1988}\OperatorTok{$}\NormalTok{education }
\NormalTok{CPS1988}\OperatorTok{$}\NormalTok{white <-}\StringTok{ }\DecValTok{0} 
\NormalTok{CPS1988}\OperatorTok{$}\NormalTok{white[CPS1988}\OperatorTok{$}\NormalTok{ethnicity}\OperatorTok{==}\StringTok{'cauc'}\NormalTok{] <-}\StringTok{ }\DecValTok{1}
\NormalTok{CPS1988}\OperatorTok{$}\NormalTok{non.white <-}\StringTok{ }\DecValTok{0} 
\NormalTok{CPS1988}\OperatorTok{$}\NormalTok{non.white[CPS1988}\OperatorTok{$}\NormalTok{white}\OperatorTok{==}\DecValTok{0}\NormalTok{] <-}\StringTok{ }\DecValTok{1} 
  
\NormalTok{mo3 <-}\StringTok{  }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data=}\NormalTok{CPS1988, }\DataTypeTok{formula=}\NormalTok{wage}\OperatorTok{~}\NormalTok{education)}
\NormalTok{mo4 <-}\StringTok{  }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data=}\NormalTok{CPS1988, }\DataTypeTok{formula=}\NormalTok{wage}\OperatorTok{~}\NormalTok{education }\OperatorTok{+}\StringTok{ }\NormalTok{educ2)}
