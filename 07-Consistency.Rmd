...
In this problem set, you generated sampling distributions of (β_1 ) ̂ when U ~ N(0,5), and were taking 1,000 samples of 1,000 observations each. Construct a “population” dataset with 1,000,000 observations with this same DGP (all other parameters of the setup stay the same).
