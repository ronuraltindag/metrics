...
Answer:
```{r ch2, echo=TRUE, message=F, warning=F, class.source="badCode", results='markup', tidy=FALSE}
...
```{r ch5, message=FALSE, warning=FALSE, class.source="badCode", results=TRUE, tidy=FALSE, echo=TRUE}
